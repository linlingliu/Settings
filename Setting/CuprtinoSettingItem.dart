...
class CupertionSettingsItem extends StatefulWidget {

  CupertionSettingsItem({Key key,
  @required this.type,
  @required this.label,
  this.subtitle,
  this.leading,
  ...
  this.onToggle,}) : assert(label != null),assert(type != null),super(key: key);
  final String label;
  ...
  @override
  _CupertionSettingsItemState createState() => _CupertionSettingsItemState();
}

class _CupertionSettingsItemState extends State<CupertionSettingsItem> {
    ...
    if (widget.subtitle == null) {
      ...
      titleSection = Column(
        ...
        children: <Widget>[
          ...
          Text(widget.subtitle, style:TextStyle(fontSize:12,letterSpacing:-0.2)),
        ],
      );
    }
    ...
    switch(widget.type){
      ...
      if (widget.value != null) {
        rightRowChildren.add(
          Padding(
            padding: const EdgeInsets.only(top: 1.5,right: 2.25),
      ...
      if (widget.hasDetails) {
        rightRowChildren.add(
          Padding(
            padding: EdgeInsets.only(top: 2.5,left: 2.25),
      ...
      rightRowChildren.add(Padding(padding: EdgeInsets.only(right: 8.5)));
      rowChildren.add(Row(children:rightRowChildren));
      break;
    }
